...
import type { DisabledTimeConfig, NzDateMode } from 'ng-zorro-antd/date-picker';

export type DefaultDateComparers = Record<NzDateMode, (date1: Date, date2: Date) => ComparisonType>;
