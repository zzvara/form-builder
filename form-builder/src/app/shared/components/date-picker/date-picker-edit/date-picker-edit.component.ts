  ...
  override ngOnInit(): void {
    ...
    this.setControlValuesBasedOnChanges({
      ...
      mode: [
        ...
        {name: "dateFormat", additionalData: (caller: AbstractControl<NzDateMode>) =>
            defaultDateFormats[caller.value]},
        {name: "showTime", additionalData: (caller: AbstractControl<NzDateMode>, current: boolean) =>
            caller.value !== "date" ? false : current},
      ],
      dateFormat: [{name: "maxDateValue", additionalData: () => null}, {name: "minDateValue", additionalData: () => null}],
      timeFormat: [{name: "maxDateValue", additionalData: () => null}, {name: "minDateValue", additionalData: () => null}],
    })
  }
