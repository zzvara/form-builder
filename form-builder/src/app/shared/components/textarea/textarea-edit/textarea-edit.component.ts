...
export class TextareaEditComponent extends AbstractFieldLikeEditForm<TextareaComponentData, string> {
    ...
    this.addControls({
      ...
      minLengthNumber:      new FormControl(null, {
        ...
        validators: [
          ...
          CustomValidators.validateMinWithMaxIf(() => [this.getStrictControlValue<boolean>("maxLength"), this.getStrictControlValue<number>("maxLengthNumber") ?? 0], () => this.getStrictControlValue<boolean>("minLength"))
        ]
      }),
      ...
      maxLengthNumber:      new FormControl(null, {
        ...
        validators: [
          ...
          CustomValidators.validateMinIf(() => this.getStrictControlValue<boolean>("minLength"), 1),
          CustomValidators.validateMaxWithMinIf(() => [this.getStrictControlValue<boolean>("minLength"), this.getStrictControlValue<number>("minLengthNumber") ?? 0], () => this.getStrictControlValue<boolean>("maxLength"))
        ]
      }),
